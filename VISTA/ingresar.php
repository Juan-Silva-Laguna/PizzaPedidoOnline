	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="ingresar.php" class="nav-link">Ingresar</a></li>
      ...
      <div class="row justify-content-center mb-5 pb-3" style="margin-right: 0px;">
        <div class="col-md-4 heading-section ftco-animate text-center">
          ...
          <br>
            ...
            <br>
            <div class="form-group">
              <input type="password" class="form-control text-center" id="clave" placeholder="Tú Contraseña">
            </div>
            <br>
            <div class="form-group">
              <select id="rol" class="form-control" >
                <option value="clientes" style="color: black;">Soy Cliente</option>
                <option value="usuarios" style="color: black;">Soy Administrador</option>
              </select>
            </div>
            <br>
            <div class="form-group">
              <input type="submit" value="Ingresar" id="btnFormu" class="btn btn-primary py-3 px-5">
            </div>
        </div>
      </div>
     ...
     $(document).ready(function(){
          $(document).on('click','#btnFormu', function (e) {       
            ...
            $.post('../CONTROLADOR/usuario.controller.php', datos, function (respuesta) {
                if (respuesta=='1') {
                  window.location.href = "Administrador/pedidos.php";
                }else if(respuesta=='2'){
                  window.location.href = "Cliente/pedido.php";
                }else{
                  $('#mensaje').html('<div class="alert alert-danger text-center">'+respuesta+'</div>'); 
                  $('#nombre').val('');
                  $('#correo').val('');
                  $('#celular').val('');
                  $('#clave').val('');    
